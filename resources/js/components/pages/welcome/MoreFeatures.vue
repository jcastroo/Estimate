    ...
    <div class="bg-gray-50 dark:bg-notion-dark py-8">
      <div class="md:max-w-5xl md:mx-auto w-full">
        <div class="my-5 text-center">
          <h3 class="font-semibold text-3xl">E muitas mais funcionalidades</h3>
          <p class="w-full mt-2 mb-8">
            SetupEstimate facilita a criação de formulários.
          </p>
