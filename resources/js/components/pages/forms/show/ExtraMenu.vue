<template>
  <div>
    ...
    <modal :show="showDeleteFormModal" icon-color="red" @close="showDeleteFormModal=false" max-width="sm">
      ...
      <div class="p-3">
        <p>
          Se desejar excluir permanentemente este formulário e todos os seus dados, pode fazê-lo abaixo.
        </p>
        <div class="flex mt-4">
          <v-button class="sm:w-1/2 mr-4" color="white" @click.prevent="showDeleteFormModal=false">Cancelar</v-button>
          <v-button class="sm:w-1/2" color="red" :loading="loadingDelete" @click.prevent="deleteForm">Confirmar</v-button>
        </div>
      </div>
    </modal>
