<template>
  <collapse class="p-4 w-full border-b" :default-value="isCollapseOpen" @click="onClickCollapse">
    ...
    <p class="mt-4">
      O código será injetado no <span class="font-semibold">head</span> da página do seu formulário. <a href="#" class="text-gray-500"
                                                                                 @click.prevent="$crisp.push(['do', 'helpdesk:article:open', ['en', 'how-to-inject-custom-code-in-my-form-1amadj3']])"
      >Clique aqui para obter um exemplo de código CSS.</a>
    </p>
