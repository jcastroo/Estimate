<template>
  <div>
    ...
    <modal :show="showModal" @close="showModal=false">
      ...
      >
        <template #help>
          Receba uma mensagem no Slack a cada submissão. <a href="https://api.slack.com/messaging/webhooks" target="_blank">Clique aqui</a> para aprender a obter uma URL de webhook do Slack.
        </template>
      </text-input>
    </modal>
  </div>
